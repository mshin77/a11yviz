...
description: "Interactive shinylive demo: a plotly chart rendered with defaults versus a11yviz layout, palette, and alt text, with a per-criterion WCAG audit."
format:
  html:
