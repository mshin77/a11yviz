...
it into a `read.csv(text = "...")` call, or replace `penguins` with
any data frame already in scope.

## Live demo {.unnumbered}

::: {.playground-collapsible role="region" aria-label="Interactive R Shiny demo: baseline vs accessible ggplot, with per-criterion WCAG audit"}
