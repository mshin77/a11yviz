...
* `a11y_check_overlap()` for scatter overlap (WCAG Success Criterion 1.3.1).
...
* Interactive playground ships as a static shinylive page inside the unified pkgdown + Quarto site — no install or R server needed.
