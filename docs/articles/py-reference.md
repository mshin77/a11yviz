...
| `scale_color_a11y(palette: str = 'dark2_8', **kwargs)` | Categorical color scale using a WCAG-tagged palette. |
| `scale_fill_a11y(palette: str = 'dark2_8', **kwargs)` | Categorical fill scale using a WCAG-tagged palette. |
