...
aligned with the [Web Content Accessibility Guidelines (WCAG
2.1)](https://www.w3.org/TR/WCAG21/). Includes WCAG-tagged palettes,
alt-text scaffolds, audits, a document rubric, heading and reading-level
checks, `shiny` ARIA helpers, and a stylesheet for `DT` and
`DiagrammeR`.
